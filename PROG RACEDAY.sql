...
INSERT INTO Routes (EventID, RouteName, DistanceKm, ElevationGainM, RouteMapURL)
VALUES
    (1, 'Down Run Route', 89.00, 1200, 'https://raceday.co.za/routes/comrades-down-2026'),
    (2, 'Peninsula Loop', 109.00, 950, 'https://raceday.co.za/routes/cycle-tour-2026'),
    (3, 'Soweto Streets Route', 42.20, 320, 'https://raceday.co.za/routes/soweto-marathon-2026');
